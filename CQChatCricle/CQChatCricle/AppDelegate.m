...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [AVOSCloud setApplicationId:@"gFjgS8otxvtN7E1m8AUuolJQ-gzGzoHsz"
                      clientKey:@"WK6fiojvfFIQezvQbFWd5RyS"];
...
//    self.MainNavigation = [[UINavigationController alloc]initWithRootViewController:mainVC];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "www.Kensence.com.CQChatCricle" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CQChatCricle" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CQChatCricle.sqlite"];
    NSError *error = nil;
